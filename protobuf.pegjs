/**
 * @fileoverview protobuf.pegjs
 * @author Frank Xu (yyfrankyy@gmail.com)
 * @license GPLv3.
 */

Protobuf
  = __ body:ProtobufBody* __ {
      return body;
    }

ProtobufBody
  = Package / Import / Option / Service / Message / Enum / Comment / Service

Package 'package'
  = kPackage __ packageName:MessageIdentifier EOS __ {
      return {type: 'package', name: packageName}
    }

Import 'import package'
  = 'import' __ packageName:StringLiteral EOS __ {
      return {type: 'import', name: packageName}
    }

Option 'option'
  = __ kOption __ optionName:OptionIdentifier __ '=' __ optionValue:Literal EOS __ {
      return {
        type: 'option'
...
EnumBody 'enum body'
  = (EnumField / Comment / Option)

Message 'message'
  = keyType:(kMessage / kExtend) __ messageName:MessageIdentifier __ '{' __ messageBody:MessageBody* __ '}' EOS __ {
      return {
...
MessageBody 'message body'
  = (Option / Message / Enum / MessageField / Comment)

FieldOption 'field option'
  = optionName:OptionIdentifier __ '=' __ optionValue:Literal {
      var o = {}
...
FieldOptionStart
  = '[' __ first:FieldOption __ ']' {
      return first;
    }

FieldOptions 'field options'
  = '[' __ first:FieldOption __ others:(',' __ sub:FieldOption {return sub;})* __ ']' {
      others.unshift(first)
      return others
    }


MessageField 'messsge field'
  = __ fieldRule:FieldRule __ fieldType:MessageIdentifier __ fieldName:Identifier __ '=' __ fieldOrder:Order __ fieldOption:FieldOptions? EOS __ {
      return {
        type: 'MessageField'
      , fieldRule: fieldRule
      , fieldType: fieldType
  ...
  / kExtensions __ from:Order to:(__ 'to' __ (Order / 'max'))* EOS __ {
  ...
  / __ fieldRule:FieldRule __ 'group' __ fieldName:Identifier __ '=' __ fieldOrder:Order __ groupBody:GroupBody* EOS __ {
      return {
...
GroupBody 'group body'
  = '{' __ body:MessageBody* __ '}' {
      return body
    }

Service 'service'
  = 'service' __ serviceName:Identifier __ '{' __ serviceBody:ServiceBody* __ '}' EOS __ {
      return {
        type: 'Service'
...
RpcField 'rpc'
  = __ 'rpc' __ methodName:Identifier __ '(' __ inputName:Identifier __ ')' __ 'returns' __ '(' __ outputName:Identifier __ ')' __ rpcFieldBody:RpcFieldBody* EOS __ {
      return {
        type: 'RpcField'
...
RpcFieldBody 'rpc body'
  = '{' __ options:Option* __ '}' {return options}
...
MessageIdentifier 'field name identifier'
  = start:IdentifierStart parts:(IdentifierPart / '.')* {
      return start + parts.join('')
    }
