  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ProtobufBody": parse_ProtobufBody,
        "Package": parse_Package,
        "Import": parse_Import,
        "Option": parse_Option,
        "Enum": parse_Enum,
        "EnumField": parse_EnumField,
        "EnumBody": parse_EnumBody,
        "Message": parse_Message,
        "MessageBody": parse_MessageBody,
        "FieldOption": parse_FieldOption,
        "FieldOptionStart": parse_FieldOptionStart,
        "FieldOptions": parse_FieldOptions,
        "MessageField": parse_MessageField,
        "GroupBody": parse_GroupBody,
        "Service": parse_Service,
        "ServiceBody": parse_ServiceBody,
        "RpcField": parse_RpcField,
        "RpcFieldBody": parse_RpcFieldBody,
        "FieldRule": parse_FieldRule,
        "FieldType": parse_FieldType,
        "Order": parse_Order,
        "kPackage": parse_kPackage,
        "kMessage": parse_kMessage,
        "kExtend": parse_kExtend,
        "kExtensions": parse_kExtensions,
        "kEnum": parse_kEnum,
        "kOption": parse_kOption,
        "Identifier": parse_Identifier,
        "OptionIdentifier": parse_OptionIdentifier,
        "MessageIdentifier": parse_MessageIdentifier,
        ...
        "OCTLEscapeSequence": parse_OCTLEscapeSequence,
        "_": parse__,
        "__": parse___,
        ...
        "NaNToken": parse_NaNToken,
        "InfToken": parse_InfToken,
        "Ll": parse_Ll,
        "Lm": parse_Lm,
        "Lo": parse_Lo,
        "Lt": parse_Lt,
      ...
      function parse_Package() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_kPackage();
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_MessageIdentifier();
            if (result2 !== null) {
              result3 = parse_EOS();
              if (result3 !== null) {
                result4 = parse___();
        ...
        if (result0 !== null) {
          result0 = (function(offset, packageName) {
      ...
      function parse_Option() {
        ...
        result0 = parse___();
        if (result0 !== null) {
          result1 = parse_kOption();
          if (result1 !== null) {
            result2 = parse___();
            if (result2 !== null) {
              result3 = parse_OptionIdentifier();
              if (result3 !== null) {
                result4 = parse___();
                if (result4 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, optionName, optionValue) {
              return {
                type: 'option'
      ...
      function parse_Enum() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, enumName, enumBody) {
              return {
                type: 'Enum'
              , enumName: enumName
              , enumBody: enumBody
      ...
      function parse_EnumField() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, enumKey, enumOrder, fieldOption) {
              return {
                type: 'EnumField'
              , fieldName: enumKey
      ...
      function parse_Message() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_kMessage();
        if (result0 === null) {
          result0 = parse_kExtend();
        }
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, keyType, messageName, messageBody) {
              return {
      ...
      function parse_MessageBody() {
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("message body");
        }
        return result0;
      }
      
      function parse_FieldOption() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_OptionIdentifier();
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            if (input.charCodeAt(pos) === 61) {
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("field option");
        }
        return result0;
      }
      
      function parse_FieldOptionStart() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
      ...
      function parse_FieldOptions() {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result5 !== null) {
                  result5 = (function(offset, sub) {return sub;})(pos2, result5[2]);
                }
                if (result5 === null) {
                  pos = pos2;
                }
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("field options");
        }
        return result0;
      }
      
      function parse_MessageField() {
        ...
        result0 = parse___();
        if (result0 !== null) {
          result1 = parse_FieldRule();
          if (result1 !== null) {
            result2 = parse___();
            if (result2 !== null) {
              result3 = parse_MessageIdentifier();
              if (result3 !== null) {
                result4 = parse___();
                if (result4 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, fieldRule, fieldType, fieldName, fieldOrder, fieldOption) {
              return {
                type: 'MessageField'
              , fieldRule: fieldRule
              , fieldType: fieldType
            ...
            })(pos0, result0[1], result0[3], result0[5], result0[9], result0[11]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, fieldRule, fieldName, fieldOrder, groupBody) {
                  return {
                ...
                })(pos0, result0[1], result0[5], result0[9], result0[11]);
            }
            if (result0 === null) {
              pos = pos0;
            }
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("messsge field");
        }
        return result0;
      }
      
      function parse_GroupBody() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
      ...
      function parse_Service() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, serviceName, serviceBody) {
              return {
                type: 'Service'
      ...
      function parse_ServiceBody() {
        var result0;
        
        reportFailures++;
        result0 = parse_RpcField();
        if (result0 === null) {
          result0 = parse_Option();
        }
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("service body");
        }
        return result0;
      }
      
      function parse_RpcField() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, methodName, inputName, outputName, rpcFieldBody) {
              return {
                type: 'RpcField'
            ...
            })(pos0, result0[3], result0[7], result0[15], result0[19]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_RpcFieldBody() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, options) {return options})(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("rpc body");
        }
        return result0;
      }
      
      function parse_FieldRule() {
        var result0;
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            if (input.substr(pos, 8) === "repeated") {
              result0 = "repeated";
              pos += 8;
            } else {
              result0 = null;
              if (reportFailures === 0) {
                matchFailed("\"repeated\"");
              }
            }
          }
        }
                    ...
                    if (result0 === null) {
                      ...
                      if (result0 === null) {
                        ...
                        if (result0 === null) {
                          ...
                          if (result0 === null) {
                            if (input.substr(pos, 8) === "sfixed32") {
                              result0 = "sfixed32";
                              pos += 8;
                            } else {
                              result0 = null;
                              if (reportFailures === 0) {
                                matchFailed("\"sfixed32\"");
                              }
                            }
                            if (result0 === null) {
                              if (input.substr(pos, 8) === "sfixed64") {
                                result0 = "sfixed64";
                                pos += 8;
                              } else {
                                result0 = null;
                                if (reportFailures === 0) {
                                  matchFailed("\"sfixed64\"");
                                }
                              }
                              if (result0 === null) {
      ...
      function parse_Order() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, negative, num) {
              var i = +(num.join(''));
              return negative == '-' ? -i : i;
      ...
      function parse_kPackage() {
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("key package");
        }
        return result0;
      }
      
      function parse_kMessage() {
        var result0;
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("key message");
        }
        return result0;
      }
      
      function parse_kExtend() {
        var result0;
        
        reportFailures++;
        if (input.substr(pos, 6) === "extend") {
          result0 = "extend";
          pos += 6;
        } else {
          result0 = null;
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("key extend");
        }
        return result0;
      }
      
      function parse_kExtensions() {
        var result0;
        
        reportFailures++;
        if (input.substr(pos, 10) === "extensions") {
          result0 = "extensions";
          pos += 10;
        } else {
          result0 = null;
          if (reportFailures === 0) {
            matchFailed("\"extensions\"");
          }
        }
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("key extensions");
        }
        return result0;
      }
      
      function parse_kEnum() {
        var result0;
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("key enum");
        }
        return result0;
      }
      
      function parse_kOption() {
        var result0;
      ...
      function parse_OptionIdentifier() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("option identifier");
        }
        return result0;
      }
      
      function parse_MessageIdentifier() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("field name identifier");
        }
        return result0;
      }
      ...
      function parse_NumericLiteral() {
        ...
        result0 = result0 !== null ? result0 : "";
        if (result0 !== null) {
          result1 = parse_HexIntegerLiteral();
          if (result1 === null) {
            result1 = parse_DecimalLiteral();
          }
          if (result1 !== null) {
            pos2 = pos;
            reportFailures++;
        ...
        if (result0 !== null) {
          result0 = (function(offset, negative, literal) {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, negative, inf) {
      ...
      function parse_EscapeSequence() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              result0 = parse_OCTLEscapeSequence();
              if (result0 === null) {
      ...
      function parse_OCTLEscapeSequence() {
        var result0, result1, result2;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, o1, o2, o3) {
